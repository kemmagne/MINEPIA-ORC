...
public class DEMProcessing extends AbstractProcessProcessing implements ProcessProcessing {
    ...
    public String processingType(OrchestraEbxmlMessage ebxml, boolean isInbound, Map params) {
        ...
        if ((action.equals(DEMConstants.DEM01) && isInbound) || ((action.equals(DEMConstants.DEM11) && !isInbound))) {
            return DEMConstants.DEM01;
        } else if (action.equals(DEMConstants.DEM01)
                || action.equals(DEMConstants.DEM02)
                || action.equals(DEMConstants.DEM04)) {
            return DEMConstants.DEM04;
        } else if (DEMConstants.DEM09.equals(action) && isInbound) {
            return DEMConstants.DEM09;
        } else if (DEMConstants.DEM09.equals(action)
                || action.equals(DEMConstants.DEM03)
                || DEMConstants.DEM10.equals(action)) {
            return DEMConstants.DEM10;
        }
    ...
    public Dossier newDossier(OrchestraEbxmlMessage ebxmlMessage) {
        ...
        if (DEMConstants.DEM01.equals(action) || DEMConstants.DEM09.equals(action)) {
            dossier = new Dossier();
            try {
    ...
    public Object getEndpoint(Process process, Partner partner, String direction, HashMap<String, Object> params) {
        ...
        if (direction.equals(Endpoint.OUTBOUND)) {
            String partnerListProperty = "dem.partner.siat.list";
            String groupListProperty = "dem.partner_group.siat.list";
            String endpointProperty = "dem.endpoint.siat";
            ...
            if (StringUtils.isBlank(epId)) {
                partnerListProperty = "dem.partner.web.list";
                groupListProperty = "dem.partner_group.web.list";
                endpointProperty = "dem.endpoint.web";
