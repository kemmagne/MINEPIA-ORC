...
public class Request extends AbstractRequest implements Serializable {
    ...
    public static final String IN_MESSAGE_PREFIX = "atm.message.in.";

    public static final String INIT_MESSAGE = "atm.message.init";

    public static final String OUT_MESSAGE_PREFIX = "atm.message.out.";

    public static final String RECORD_PAYED = "atm.recordPayed";
    ...
    protected void init(OrchestraEbxmlMessage ebxmlMessage, Map<String, ? extends Object> params) {
        ...
        dossier.setProperty(ATMConstants.INIT_ACTION_PROPERTY, ebxmlMessage.getAction());
    }
    ...
    public String getRecieverPartner() {
        String id = getDossier().getProperty("atm.partner.receiver");
        return id;
    }
    ...
    public String getInitAction() {
        return getDossier().getProperty(ATMConstants.INIT_ACTION_PROPERTY);
    }
