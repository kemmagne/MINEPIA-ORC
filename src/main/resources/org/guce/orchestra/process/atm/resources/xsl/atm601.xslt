            ...
            <xsl:for-each select="DOCUMENT">
                ...
                <xsl:for-each select="CONTENT">
                    <CONTENT>
                        ...
                        <xsl:for-each select="DATE_ATM_MINEPIA">
                            <DATE_ATM_MINEPIA>
                                <xsl:value-of select="string(.)"/>
                            </DATE_ATM_MINEPIA>
                        </xsl:for-each>
                        <xsl:for-each select="DATE_ATM_EXP">
                            <DATE_ATM_EXP>
                                <xsl:value-of select="string(.)"/>
                            </DATE_ATM_EXP>
                        </xsl:for-each>
                        ...
                        <xsl:for-each select="FOURNISSEUR">
                            <FOURNISSEUR>
                                <xsl:for-each select="NUMERO_CONTRIBUABLE">
                                    <NUMERO_CONTRIBUABLE>
                                    <xsl:value-of select="string(.)"/>
                        ...
                        <xsl:for-each select="FACTURE">
                            <FACTURE>
                                ...
                                <xsl:for-each select="MONTANT_FACTURE">
                                    <MONTANT_FACTURE>
                                    <xsl:value-of select="string(.)"/>
                                    </MONTANT_FACTURE>
                                </xsl:for-each>
                                <xsl:for-each select="DEVISE_FACTURE">
                                    <DEVISE_FACTURE>
                        ...
                        <xsl:for-each select="TRANSPORT">
                            <TRANSPORT>
                                <xsl:for-each select="NUMERO_BL">
                                    <NUMERO_BL>
                                    <xsl:value-of select="string(.)"/>
                                    </NUMERO_BL>
                                </xsl:for-each>
                                <xsl:for-each select="NUMERO_VOYAGE">
                                    <NUMERO_VOYAGE>
                                    <xsl:value-of select="string(.)"/>
                                    </NUMERO_VOYAGE>
                                </xsl:for-each>
                                <xsl:for-each select="DATE_DEPART">
                                    <DATE_DEPART>
                                    <xsl:value-of select="string(.)"/>
                                    </DATE_DEPART>
                                </xsl:for-each>
                                <xsl:for-each select="DATE_ARRIVEE">
                                    <DATE_ARRIVEE>
                                    <xsl:value-of select="string(.)"/>
                                    </DATE_ARRIVEE>
                                </xsl:for-each>
                                ...
                                <xsl:for-each select="LIEU_DEDOUANEMENT">
                                    <LIEU_DEDOUANEMENT>
                                    <xsl:for-each select="UNLOCODE">
                                    <UNLOCODE>
                                    <xsl:value-of select="string(.)"/>
